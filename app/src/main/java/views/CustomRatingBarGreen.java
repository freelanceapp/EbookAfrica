...
public class CustomRatingBarGreen extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.edook_filled_star;
    private int mStarOffResource = R.drawable.ebook_star_empty;
    private int mStarHalfResource = R.drawable.ebook_star_h_empty;

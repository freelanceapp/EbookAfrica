 ...
 */
public class CustomRatingBarGrey extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.edook_filled_star_grey;
    private int mStarOffResource = R.drawable.ebook_star_empty_grey;
    private int mStarHalfResource = R.drawable.ebook_star_h_empty_grey;
    ...
    public CustomRatingBarGrey(Context context) {
        super(context);
        init();
    }
    ...
    public CustomRatingBarGrey(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarGrey(Context context, AttributeSet attrs, int defStyle) {

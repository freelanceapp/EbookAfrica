...
public class PlaceOrder_OrderDetail {
    ...
    @Expose
    private List<PlaceOrder_Product> placeOrderProducts = new ArrayList<PlaceOrder_Product>();
    @SerializedName("order_totals")
    @Expose
    private List<PlaceOrder_OrderTotal> placeOrderOrderTotals = new ArrayList<PlaceOrder_OrderTotal>();
     ...
     *     The products
     */
    public List<PlaceOrder_Product> getPlaceOrderProducts() {
        return placeOrderProducts;
    }

    /**
     * 
     * @param placeOrderProducts
     *     The products
     */
    public void setPlaceOrderProducts(List<PlaceOrder_Product> placeOrderProducts) {
        this.placeOrderProducts = placeOrderProducts;
    }
     ...
     *     The orderTotals
     */
    public List<PlaceOrder_OrderTotal> getPlaceOrderOrderTotals() {
        return placeOrderOrderTotals;
    }

    /**
     * 
     * @param placeOrderOrderTotals
     *     The order_totals
     */
    public void setPlaceOrderOrderTotals(List<PlaceOrder_OrderTotal> placeOrderOrderTotals) {
        this.placeOrderOrderTotals = placeOrderOrderTotals;
    }

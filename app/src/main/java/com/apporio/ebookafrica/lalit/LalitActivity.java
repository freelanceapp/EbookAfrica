...
public class LalitActivity extends Activity {
    ...
    public void copyToDevice(String fileName) {
        if (!this.fileExists(fileName)){
            try
            {
                ...
                Log.e(TAG, fileName+" copied to phone");
            }
    ...
    private void installBook(String fileName) {
        if (this.fileExists(fileName)){
            Log.e(TAG, fileName+ " already exist. try to delete old file.");
    ...
    private void startBookViewActivity() {
        Intent intent = new Intent(LalitActivity.this,BookViewActivity.class);
